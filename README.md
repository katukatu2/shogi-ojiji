...
| 2 | 良い手じゃな。だがワシならこう打つな。 | 100 点以上落ちた。または、指したあと +500 以上で落ち幅が 300 点未満（勝っているうちは責めない） | 止めない。吹き出しとオジジの手の緑表示 |
...
- 二行の形勢は、指す前の読みが 14 手（`SHALLOW_DEPTH`）未満なら「（読み N 手・目安）」と添える。14 は到達保証ではなく、浅い評価を断定しないための表示基準。2スレッド・400ms・MultiPV 2 の回帰試験では初期局面16、10手目13（2026-09-10の一実行）だった。局面・端末・負荷によって変わり、中盤では目安表示が多くなる。表示を減らすために閾値を下げず、試験は実条件の到達深さも記録する。
