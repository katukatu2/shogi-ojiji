...
- 最善手の狙いの説明（「ここは▲○○と…する手じゃ」）は、まず相手の狙いを読んでから言う。先手番の局面を後手番として（SFEN で手番を入れ替えて）読み、相手に手番を渡すと 150 点以上損する狙いがあり、最善手を指すと相手の応手がその狙いと変わるなら「△○○を防ぐ手」と言う。狙いが無ければ盤の形から言い、「玉の守りを固める」は玉に接する駒に限る（離れた自陣の手は「自陣の隙を消す」）。
